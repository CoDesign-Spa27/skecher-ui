...
const FILE_PATH = "components/ui-components/morphing-action-dock.tsx";

export async function MorphingActionDockDoc({ page }: { page: ComponentDoc }) {
  ...
  return (
    <ComponentWrapper
      ...
      title="morphing-action-dock.tsx"
    >

...
const FILE_PATH = "components/ui-components/interactive-grid-hero.tsx";

export async function InteractiveGridHeroDoc({ page }: { page: ComponentDoc }) {
  ...
  return (
    <ComponentWrapper
      ...
      title="interactive-grid-hero.tsx"
    >

...
const FILE_PATH = "components/ui-components/3d-wheel-carousel.tsx";

export async function ThreeDWheelCarouselDoc({ page }: { page: ComponentDoc }) {

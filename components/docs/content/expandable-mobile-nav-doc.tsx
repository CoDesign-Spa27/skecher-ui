...
const FILE_PATH = "components/ui-components/expandable-mobile-nav.tsx";

export async function ExpandableMobileNavDoc({ page }: { page: ComponentDoc }) {
  ...
  return (
    <ComponentWrapper
      ...
      title="expandable-mobile-nav.tsx"
    >

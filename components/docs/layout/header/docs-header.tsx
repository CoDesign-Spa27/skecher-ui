...
const DocsHeader = () => {
    return (
        <header
            className={cn(
                "fixed left-1/2 top-5 z-50 flex h-10 max-w-2xl shrink-0 -translate-x-1/2 items-center justify-between gap-1 rounded-xl bg-sidebar px-1 header-shadow md:-translate-x-[calc(100%+0.25rem)]"
            )}
            >

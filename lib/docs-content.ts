...
} from "@/components/ui/expandable-mobile-nav";
...
const navItems: readonly ExpandableMobileNavEntry[] = [
  ...
  { id: "more", label: "More", icon: IconUnorderedListFill18 },
];

export default function ExpandableMobileNavExample() {
  return (
    <ExpandableMobileNav
      navItems={navItems}
      expandedPanel={{
    ...
    files: [
      {
        path: "components/ui-components/expandable-mobile-nav.tsx",
        description: "Generic expandable navigation component",
      },
    ],
    assets: [
      {
        path: "public/pfp.png",
        description: "Add the avatar used by the profile card, or replace it with your own image.",
      },
    ],
  },
  {
